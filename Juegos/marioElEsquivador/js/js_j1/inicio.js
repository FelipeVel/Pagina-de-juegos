...
var Inicio = {
    ...
    create: function(){
        ...
        var txtTitulo = juego.add.text(juego.width/2, juego.height/2 -100, "Mario el Esquivador", 
...
document.write('<script src="js/js_j1/juego.js"></script>');
document.write('<script src="js/js_j1/fin.js"></script>');
document.write('<script src="js/js_j1/principal.js"></script>');