...
function cargarImagenes(){
  imgFondo = new Image();
  imgFondo.src = 'Juegos/FlappyBird/mockups/fondofinal.jpg';
  imgTuboA = new Image();
  imgTuboA.src = 'Juegos/FlappyBird/mockups/tuberia.png';
  imgTuboB = new Image();
  imgTuboB.src = 'Juegos/FlappyBird/mockups/tuberiab.png';
  imgAveA = new Image();
  imgAveA.src = 'Juegos/FlappyBird/mockups/avev11.png';
}
